Public Class frmLab3
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboSize.SelectedIndexChanged
        Dim Size As Integer
        Integer.TryParse(cboSize.Text, Size)
    ...
    Private Sub lblFSky_Click(sender As Object, e As EventArgs) Handles lblFSkyblue.Click
    ...
    Private Sub frmLab3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cboSize.Items.Add(30)
        cboSize.Items.Add(34)
        cboSize.Items.Add(38)
        cboSize.Items.Add(42)
        cboSize.Items.Add(46)
        cboSize.Items.Add(50)
        cboSize.Items.Add(54)
        cboSize.Items.Add(58)
        cboSize.Items.Add(62)
        cboSize.Items.Add(66)
        cboSize.Items.Add(70)
